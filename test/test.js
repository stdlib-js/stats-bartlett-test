...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof bartlettTest, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function returns an object with a `.print()` method for printing a formatted output table', function test( t ) {
	...
	table = out.print();
	t.strictEqual( typeof table, 'string', 'returns expected value' );
